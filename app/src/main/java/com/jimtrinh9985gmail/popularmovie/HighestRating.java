 ...
 */
public class HighestRating extends AppCompatActivity implements HighestRatingFragment.Callback {

    private boolean mTwoPane;
    private static final String DETAILFRAGMENT_TAG1 = "DFTAG";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.highest_activity);
        ...
        if (findViewById(R.id.detail_view_container) !=null ) {
            ...
            mTwoPane = false;
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.fragment_main, new HighestRatingFragment()).commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_highest_rated:
                Intent intent1 = new Intent(this, HighestRatingFragment.class);
